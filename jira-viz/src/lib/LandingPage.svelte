<script lang="ts">
  ...
  const queries = [
    {
      q: "Show top 200 open issues with blocker, major priority in project Kafka, Zookeeper, Hive",
      chart: "bar",
    },
    {
      q: "Show me all the top burning topics in project Hadoop, Flink",
      chart: "line",
    },
    {
      q: "Who are the top 10 reporters and what types of issues do they log in project Hive",
      chart: "pie",
    },
  ];
...
<div class="landing">
  ...
  <nav class="nav">
    ...
    <div class="nav-links">
      <a
        href="https://github.com/sunishbharat/AtlasMind-frontendUI"
        target="_blank"
  ...
  <section class="hero">
    ...
    <h1 class="headline">
      Ask your Jira data anything. Get answers in seconds.
    </h1>
    <p class="subheadline">
      No dashboards to build. No SQL to write. No account to create. Type a
      question in plain English — AtlasMind turns your Jira backlog into instant
      charts and insights. Free and open source, forever.
    </p>
      ...
      <div class="demo-content">
        ...
        <div class="demo-response">
          <div class="demo-chart">
            <ChartRenderer
              option={buildDemoChart(queries[currentQuery].chart)}
              height="200px"
            />
          </div>
        </div>
  ...
  <section class="trust">
    <p class="trust-tagline">
      Read the source, run it yourself, or contribute — it's all on GitHub.
    </p>
  </section>
